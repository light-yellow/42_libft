...
SRCS=ft_atoi.c ft_bzero.c ft_isalnum.c ft_strndup.c ft_strarr_del.c \
	 ft_isalpha.c ft_isascii.c ft_isdigit.c ft_islower.c ft_isprint.c \
	 ft_isupper.c ft_itoa.c \
...
OBJECTS=ft_atoi.o ft_bzero.o ft_isalnum.o ft_strndup.o ft_strarr_del.o \
		ft_isalpha.o ft_isascii.o ft_isdigit.o ft_islower.o ft_isprint.o \
		ft_isupper.o ft_itoa.o \
